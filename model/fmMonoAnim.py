...
import math
import sys
from fmMonoBlock import convolution_with_state
...
def animate_update(block_count, iq_data, block_size, rf_coeff, audio_coeff,state_mono_lpf_16k):
...
if __name__ == "__main__":
	...
	audio_coeff = signal.firwin(rf_taps,rf1_Fc/((if_Fs/2)),window=('hann')) # to be changed by you
	...
	try:
		...
		ani = animation.FuncAnimation(fig, animate_update, \
						...
						fargs=(iq_data, block_size, rf_coeff, audio_coeff,state_mono_lpf_16k ))
		plt.show()
